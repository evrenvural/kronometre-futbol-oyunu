...
public class AiryUIAnimatedElement : MonoBehaviour
{
    ...
    private IEnumerator AnimateToCornerWithScale_HIDE()
    {
        ...
        Vector3 targetPosition = AiryUIAnimationPositions.GetStartPositionFromCorner(initialWorldPosition, rectTransform, animationToCornerType, AnimationFromCornerStartFromType.Screen);
        rectTransform.position = startPos;
